...
public class FileOperate {
	 ...
	 * 剪切文件或文件夹
	 * 
	 * @param srcPath from路径
	 * @param destDir to路径
	 * @return
	 */
	public static boolean copyGeneralFile(String srcPath, String destDir) throws InterruptedException {
		boolean flag = false;
		...
		if (file.isFile()) { // 源文件
			System.out.println("下面进行文件剪切!"+file.getName());
			flag = copyFile(srcPath, destDir);
		} else if (file.isDirectory()) {
			System.out.println("下面进行文件夹剪切!");
	 ...
	 * @return boolean
	 */
	private static boolean copyFile(String srcPath, String destDir) throws InterruptedException {
		boolean flag = false;
	 ...
	 * @return
	 */
	private static boolean copyDirectory(String srcPath, String destDir) throws InterruptedException {
	 ...
	 *            同上
	 */
	public static boolean cutGeneralFile(String srcPath, String destDir) throws InterruptedException {
